...
ENVS="-e LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/software/gcc-4.7.2/lib64:$R/lib:$R/library/Rcpp/libs:$R/library/RInside/lib:$R/library/RInside/libs -e R_HOME=/home/wozniak/Public/sfw/blues/R-3.4.3/lib64/R -e X"
set -x
